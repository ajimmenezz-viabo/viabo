import{am as S,an as j,aQ as x,W as R,ao as h,d as N,aR as m,r as v,ap as _,aq as $,j as i,as as M,at as U,S as T,T as A,I as L}from"./build-25e7e2eb.js";import{g as V,t as X,a as B,M as I}from"./build-b4439384.js";import{f as P,a as W}from"./build-e8a6b0bf.js";import{V as E,a as F}from"./build-3cc84a75.js";function K(t){return S("MuiSkeleton",t)}j("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const O=["animation","className","component","height","style","variant","width"];let d=t=>t,g,f,b,C;const q=t=>{const{classes:a,variant:e,animation:s,hasChildren:o,width:r,height:n}=t;return U({root:["root",e,s,o&&"withChildren",o&&!r&&"fitContent",o&&!n&&"heightAuto"]},K,a)},z=x(g||(g=d`
  0% {
    opacity: 1;
  }
...
`)),Q=R("span",{name:"MuiSkeleton",slot:"Root",overridesResolver:(t,a)=>{const{ownerState:e}=t;return[a.root,a[e.variant],e.animation!==!1&&a[e.animation],e.hasChildren&&a.withChildren,e.hasChildren&&!e.width&&a.fitContent,e.hasChildren&&!e.height&&a.heightAuto]}})(({theme:t,ownerState:a})=>{const e=V(t.shape.borderRadius)||"px",s=X(t.shape.borderRadius);return h({display:"block",backgroundColor:t.vars?t.vars.palette.Skeleton.bg:N(t.palette.text.primary,t.palette.mode==="light"?.11:.13),height:"1.2em"},a.variant==="text"&&{marginTop:0,marginBottom:0,height:"auto",transformOrigin:"0 55%",transform:"scale(1, 0.60)",borderRadius:`${s}${e}/${Math.round(s/.6*10)/10}${e}`,"&:empty:before":{content:'"\\00a0"'}},a.variant==="circular"&&{borderRadius:"50%"},a.variant==="rounded"&&{borderRadius:(t.vars||t).shape.borderRadius},a.hasChildren&&{"& > *":{visibility:"hidden"}},a.hasChildren&&!a.width&&{maxWidth:"fit-content"},a.hasChildren&&!a.height&&{height:"auto"})},({ownerState:t})=>t.animation==="pulse"&&m(b||(b=d`
    ...
    `),H,(a.vars||a).palette.action.hover)),D=v.forwardRef(function(a,e){const s=_({props:a,name:"MuiSkeleton"}),{animation:o="pulse",className:r,component:n="span",height:l,style:u,variant:y="text",width:k}=s,c=$(s,O),p=h({},s,{animation:o,component:n,variant:y,hasChildren:!!c.children}),w=q(p);return i.jsx(Q,h({as:n,ref:e,className:M(w.root,r),ownerState:p},c,{style:h({width:k,height:l},u)}))}),tt=D;function at({card:t,disableShow:a,color:e}){var n;const[s,o]=v.useState(!0),r=l=>{l.stopPropagation(),o(u=>!u)};return i.jsxs(T,{direction:"row",alignItems:"center",spacing:1,children:[((n=t==null?void 0:t.cardType)==null?void 0:n.toLowerCase())!=="mastercard"?i.jsx(B,{color:e}):i.jsx(I,{color:e}),i.jsx(A,{sx:{typography:"h6"},children:s?P(t==null?void 0:t.cardNumber):W(t==null?void 0:t.cardNumber)}),!a&&i.jsx(i.Fragment,{children:i.jsx(L,{size:"small",color:"inherit",onClick:r,sx:{opacity:.2},children:s?i.jsx(E,{}):i.jsx(F,{})})})]})}export{at as C,tt as S};
