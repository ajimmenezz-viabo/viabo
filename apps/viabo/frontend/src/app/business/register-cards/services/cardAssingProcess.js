...
const FormRegisterUserCard = lazy(() => import('@/app/business/register-cards/components/FormRegisterUserCard'))
const FormUserCardValidation = lazy(() => import('@/app/business/register-cards/components/FormUserCardValidation'))
...
export const CARD_ASSIGN_STEPS = [
  { name: CARD_ASSIGN_PROCESS_LIST.USER_REGISTER, step: 1, content: FormRegisterUserCard },
