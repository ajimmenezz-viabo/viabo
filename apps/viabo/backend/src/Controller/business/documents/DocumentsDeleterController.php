...
use Viabo\business\documents\application\delete\DeleteDocumentsCommand;
...
final readonly class DocumentsDeleterController extends ApiController
{
    public function __invoke(Request $request): Response
    {
        try {
            ...
            $this->dispatch(new DeleteDocumentsCommand($tokenData['id'] , $commerceId , $uploadDocuments));
